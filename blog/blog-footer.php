              ...
              <div class="col-md-6 mb-4">
                <div id="text-2" class="widget-container widget_text">
                  <div class="textwidget">
                    <div class="textwidget">
                      <div class="logo"><img class="logo-white lazy" data-src="/assets/logo/Stueys-Green-Auto-Clean-Logo.png" alt="Stueys Green Auto Clean"  width="256" height="90"></div>
                      <ul class="social-icons">
                        <li>
                          <a href="https://www.facebook.com/stueysgreenautoclean/" target="_blank" rel="noreferrer">
                            <img class="lazy" data-src="/assets/icons/facebook.png" alt="facebook" width="32px" height="32px">
                          </a>
                        </li>
                        <li><a href="https://twitter.com/xxx" target="_blank" rel="noreferrer">
                            <img class="lazy" data-src="/assets/icons/twitter.png" alt="twitter" width="32px" height="32px"></a>
                        </li>
                        <li><a href="https://www.instagram.com/stueysgreenautoclean/" target="_blank" rel="noreferrer">
                            <img class="lazy" data-src="/assets/icons/instagram.png" alt="instagram" width="32px" height="32px"></a>
                        </li>
                      </ul>
                      <ul>
                        <li>
                          <a href="https://www.paypal.me/stueysgreenautoclean" target="_blank" rel="noreferrer">
                            <img class="trade-logo lazy" data-src="/assets/images/Paypal.webp" alt="paypal payments"  width="180" height="180">
                          </a>
                        </li>
                      </ul>
                      <ul>
                        <li>
                          <a href="https://www.paypal.com/qrcodes/venmocs/xxx" target="_blank" rel="noreferrer">
                            <img class="trade-logo lazy" data-src="/assets/images/Venmo-Payment.webp" alt="paypal payments"  width="186" height="156">
                          </a>
                        </li>
                      </ul>
                    </div>
    ...
    <div class="container wow fadeIn" data-wow-duration="2s" data-wow-delay="0s">
        <div class="row">
            ...
            <p>©  2022 Stuey's Green Auto Clean, LLC. All rights reserved.</p>
        </div>
    </div>
</section>
...
<section id="modal-window" class="">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal_body modal-1">
                    ...
                    <p class="popup-text">Get $25 Off Your First Auto Detail*</p>
                </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal_body modal-2">
                    <img class="lazy" data-src="/assets/images/modal-window-2nd.png" alt="Great! Where should you send $25 off coupon?" width="440">
                </div>
                ...
                <p><input id="fieldItemPopup" class="your-item w-100" name="your-item" type="text" placeholder="Enter Your Item Need To Be Cleaned" required></p>
                                <button class="modal-button required border-0 w-100 bg-green text-white" type="submit" id="submit-btn-popup" name="get_coupon" aria-label="Get Coupon">Get My $25 Off Coupon</button>
                            </form>
                        </div>
                    </div>
                    ...
                    <div id="nothankstext"><span class="close nothanks">No! I do not want a free $25 off coupon</span></div>
                </div>
            </div>
            <div id="modal_no" class="modal">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal_body modal-3"><img class="lazy" data-src="/assets/images/modal-window-3nd.png" alt="Check your inbox for your $25 off coupon!" width="460" height="145"></div>
    ...
    <script type="text/javascript" src="../assets/libs/lazysizes/lazysizes.min.js" defer ></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/lightbox2/2.11.3/js/lightbox.min.js" defer type="text/javascript"></script>
    <script src="../assets/js/bundle.js" defer type="text/javascript"></script>
    <script src="../assets/js/slick.js" defer type="text/javascript"></script>
    <script src="../assets/libs/OwlCarousel2/owl.carousel-min.js" defer type="text/javascript"></script>
    <script src="../assets/js/page_scripts.js" defer type="text/javascript"></script>
