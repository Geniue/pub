                    ...
                    <div class="card-body invoice-head">
                        <div class="row">
                            <div class="col-md-4 align-self-center">
                                <img src="../assets/images/logo-sm.png" alt="logo-small" class="logo-sm mr-2" height="26">
                                <img src="../assets/images/logo-dark.png" alt="logo-large" class="logo-lg" height="16">
