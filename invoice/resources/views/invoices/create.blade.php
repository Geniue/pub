                                ...
                                <ul class="list-inline mb-0 contact-detail float-right">
                                    <li class="list-inline-item">
                                        <div class="pl-3 d-flex">
                                            ...
                                            <p class="text-muted mt-2">https://stueysgreenautoclean.com/</p>
                                        </div>
                                    </li>
                                    <li class="list-inline-item">
                                        <div class="pl-3 d-flex">
                                            <i class="mdi mdi-phone"></i>
                                            <p class="text-muted mt-2">917-877-0105</p>
                                        </div>
                                    </li>
                                    <li class="list-inline-item">
                                        <div class="pl-3 d-flex">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <h6 class="mb-0"><b>Invoice No :</b> <input type="text" class="form-control" name="invoice_no" value="PG-{{rand(0,10000)}}" readonly></h6>
