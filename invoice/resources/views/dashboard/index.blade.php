                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-8">
                                ...
                                <h3 class="font-weight-semibold mb-1">{{$invoices->count()}}</h3>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-8">
                                ...
                                <h3 class="font-weight-semibold mb-1">{{$new_invoices->count()}}</h3>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-8">
                                ...
                                <h3 class="font-weight-semibold mb-1">{{$paid_invoices->count()}}</h3>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-8">
                                ...
                                <h3 class="font-weight-semibold mb-1">{{$unpaid_invoices->count()}}</h3>
