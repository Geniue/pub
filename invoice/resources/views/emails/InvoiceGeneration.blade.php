            ...
            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row container-padding" width="640" style="width:640px;max-width:640px;" Simpli>
                ...
                <tr>
                    <td align="center" class="center-text">
                        <img style="width:120px;border:0px;display: inline!important;" src="{{asset('backend/images/logo.png')}}" width="120" border="0" editable="true" Simpli data-image-edit  Simpli alt="logo">
                    </td>
                </tr>
                <tr>
                    <td height="30" style="font-size:30px;line-height:30px;" Simpli>&nbsp;</td>
                            ...
                            <tr>
                                <td align="center" Simpli bgcolor="#FFFFFF"  style="border-radius:0 0 36px 36px; border-bottom:solid 6px #DDDDDD;">
                                    ...
                                    <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row container-padding" width="520" style="width:520px;max-width:520px;">
                                        <tr>
                                            <td class="center-text" Simpli align="center" style="font-family:'Catamaran',Arial,Helvetica,sans-serif;font-size:40px;line-height:54px;font-weight:700;font-style:normal;color:#1898c2;text-decoration:none;letter-spacing:0px;">
                                                <singleline>
                                                    <div mc:edit Simpli>
                                                        INVOICE
                                                    </div>
...
{{--                                                            <![endif]-->--}}
{{--                                                            <singleline>--}}
{{--                                                                <a href="#" target="_blank" mc:edit  style="font-family:'Catamaran',Arial,Helvetica,sans-serif;font-size:16px;line-height:20px;font-weight:700;font-style:normal;color:#FFFFFF;text-decoration:none;letter-spacing:0px;padding: 15px 35px 15px 35px;display: inline-block;"><span>MY ACCOUNT</span></a>--}}
{{--                                                            </singleline>--}}
{{--                                                            <!--[if (gte mso 9)|(IE)]>--}}
{{--                                                            </td>--}}
{{--                                                            <td align="center" width="35"></td>--}}
                                                    ...
                                                    <tr>
                                                        <td align="center">
                                                            ...
                                                            <table border="0" align="left" cellpadding="0" cellspacing="0" role="presentation" class="row m-padding-top20" width="235" style="width:235px;max-width:235px;">
                                                                <tr>
                                                                    <td class="center-text" Simpli align="left" style="font-family:'Catamaran',Arial,Helvetica,sans-serif;font-size:16px;line-height:24px;font-weight:700;font-style:normal;color:#333333;text-decoration:none;letter-spacing:0px;">
                                                                        <singleline>
                                                                            <div mc:edit Simpli>
                                                                                Invoice No# <strong style="color:#1898c2;">{{$invoice->info->invoice_no}}</strong>
                                                                            </div>
                                                                        </singleline>
                                                                    </td>
                                                                </tr>
                                                                ...
                                                                <tr>
                                                                    <td class="center-text" Simpli align="left" style="font-family:'Catamaran',Arial,Helvetica,sans-serif;font-size:16px;line-height:20px;font-weight:400;font-style:normal;color:#6e6e6e;text-decoration:none;letter-spacing:0px;">
                                                                        <singleline>
                                                                            <div mc:edit Simpli>
                                                                                {{\Carbon\Carbon::parse($invoice->info->start_date)->format('d/m/Y')}}
                                                                            </div>
                                                                        </singleline>
                                                                    </td>
                                                                </tr>
                                                            ...
                                                            <table border="0" align="right" cellpadding="0" cellspacing="0" role="presentation" class="row" width="235" style="width:235px;max-width:235px;">
                                                                ...
                                                                <tr>
                                                                    <td class="center-text" Simpli align="left" style="font-family:'Catamaran',Arial,Helvetica,sans-serif;font-size:16px;line-height:20px;font-weight:400;font-style:normal;color:#6e6e6e;text-decoration:none;letter-spacing:0px;">
                                                                        <singleline>
                                                                            <div mc:edit Simpli>
                                                                                {{$invoice->info->charge_to!=null ? $invoice->info->charge_to:''}} <br>
                                                                                {{$invoice->info->send_to!=null ? $invoice->info->send_to:''}}<br>
                                                                                {{$invoice->info->charge_phone!=null ? $invoice->info->charge_phone:''}}
                                                                            </div>
                                                                        </singleline>
                                                                    </td>
                                                                </tr>
            ...
            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row container-padding25" width="600" style="width:600px;max-width:600px;" Simpli>
                ...
                <tr>
                    <td align="center" Simpli bgcolor="#FFFFFF"  style="border-radius:36px 36px 0 0;">
                        ...
                        <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row container-padding" width="520" style="width:520px;max-width:520px;">
                            <tr>
                                <td align="center" Simpli style="border-bottom: 4px dotted #DDDDDD;">
                                    <!-- Invoice Titles -->
                                    <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;">
                                        <tr>
                                            <td colspan="5" height="20" style="font-size:20px;line-height:20px;">&nbsp;</td>
                                        </tr>
                                        <tr>
                                            <td Simpli align="left" width="40%" style="width:40%;max-width:40%;font-family:'Catamaran',Arial,Helvetica,sans-serif;font-size:20px;line-height:24px;font-weight:700;font-style:normal;color:#333333;text-decoration:none;letter-spacing:0px;">
                                                <singleline>
                                                    <div mc:edit Simpli>
                                                        Item
                                                    </div>
                                            ...
                                            <td Simpli align="center" width="8%" style="width:8%;max-width:8%;font-family:'Catamaran',Arial,Helvetica,sans-serif;font-size:20px;line-height:24px;font-weight:700;font-style:normal;color:#333333;text-decoration:none;letter-spacing:0px;">
                                                <singleline>
                                                    <div mc:edit Simpli>
                                                        Package
                                                    </div>
                                            ...
                                            <td align="left" width="4%" style="width:4%;max-width:4%;"></td>
                                            <td Simpli align="right" width="44%" style="width:44%;max-width:44%;font-family:'Catamaran',Arial,Helvetica,sans-serif;font-size:20px;line-height:24px;font-weight:700;font-style:normal;color:#333333;text-decoration:none;letter-spacing:0px;">
                                                <singleline>
                                                    <div mc:edit Simpli>
                                                        Price
                                                    </div>
                    ...
                    <td align="center" Simpli bgcolor="#FFFFFF" style="border-radius:0;">
                        ...
                        <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row container-padding" width="520" style="width:520px;max-width:520px;">
                            ...
                            <tr>
                                ...
                                <td align="left" width="4%" style="width:4%;max-width:4%;"></td>
                                <td Simpli align="center" valign="top" width="8%" style="width:8%;max-width:8%;font-family:'Catamaran',Arial,Helvetica,sans-serif;font-size:20px;line-height:26px;font-weight:700;font-style:normal;color:#000000;text-decoration:none;letter-spacing:0px;">
                                    <singleline>
                                        <div mc:edit Simpli>
                                            {{$item->package}}
                                        </div>
                                ...
                                <td align="left" width="4%" style="width:4%;max-width:4%;"></td>
                                <td Simpli align="right" valign="top" width="44%" style="width:44%;max-width:44%;font-family:'Catamaran',Arial,Helvetica,sans-serif;font-size:20px;line-height:26px;font-weight:700;font-style:normal;color:#000000;text-decoration:none;letter-spacing:0px;">
                                    <singleline>
                                        <div mc:edit Simpli>
                                            $ {{$item->fixed_price}}
                                        </div>
            ...
            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row container-padding25" width="600" style="width:600px;max-width:600px;" Simpli>
                ...
                <tr>
                    <td align="center" Simpli bgcolor="#FFFFFF"  style="border-radius:0 0 36px 36px; border-bottom:solid 6px #DDDDDD;">
                        ...
                        <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row container-padding" width="520" style="width:520px;max-width:520px;">
                            <tr>
                                <td height="15"  style="border-bottom: 4px dotted #E4E4E4;font-size:15px;line-height:15px;">&nbsp;</td>
                            </tr>
                            <tr>
                                <td height="30" style="font-size:30px;line-height:30px;" Simpli>&nbsp;</td>
                            </tr>
                                    ...
                                    <table border="0" align="left" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;">
                                        <tr>
                                            <td>
                                                <!--[if (gte mso 9)|(IE)]><table border="0" cellpadding="0" cellspacing="0"><tr><td><![endif]-->
                                                <!-- column -->
                                                <table border="0" align="left" cellpadding="0" cellspacing="0" role="presentation" class="row" width="240" style="width:240px;max-width:240px;">
                                                    <tr>
                                                        <td class="center-text" Simpli align="left" style="font-family:'Catamaran',Arial,Helvetica,sans-serif;font-size:20px;line-height:24px;font-weight:700;font-style:normal;color:#00000c;text-decoration:none;letter-spacing:0px;">
                                                            <singleline>
                                                                <div mc:edit Simpli>
                                                                    Payment Method
                                                                </div>
                                                    ...
                                                    <tr>
                                                        <td class="center-text" Simpli align="left" style="font-family:'Catamaran',Arial,Helvetica,sans-serif;font-size:16px;line-height:40px;font-weight:400;font-style:normal;color:#6e6e6e;text-decoration:none;letter-spacing:0px;">
                                                            <singleline>
                                                                <div mc:edit Simpli>
                                                                   {{$invoice->info->payment_method}}
                                                                </div>
                                                            </singleline>
                                                        </td>
                                                    </tr>
                                                ...
                                                <!--[if (gte mso 9)|(IE)]></td><td><![endif]-->
                                                <!-- column -->
                                                <table border="0" align="left" cellpadding="0" cellspacing="0" role="presentation" class="row m-padding-top20" width="250" style="width:250px;max-width:250px;">
                                                    <tr>
                                                        <td align="center">
                                                            <!-- row -->
                                                                ...
                                                                <tr>
                                                                    <td align="center">
                                                                        ...
                                                                        <table border="0" align="left" cellpadding="0" cellspacing="0" role="presentation" width="100" style="width:100px;max-width:100px;">
                                                                            <tr>
                                                                                <td Simpli align="right" style="font-family:'Catamaran',Arial,Helvetica,sans-serif;font-size:20px;line-height:30px;font-weight:700;font-style:normal;color:#00000c;text-decoration:none;letter-spacing:0px;">
                                                                                    <singleline>
                                                                                        <div mc:edit Simpli>
                                                                                            Subtotal:
                                                                                        </div>
                                                                            ...
                                                                            @if($invoice->surchages!=0.00 | $invoice->surchages!=null)
                                                                            <tr>
                                                                                <td Simpli align="right" style="font-family:'Catamaran',Arial,Helvetica,sans-serif;font-size:20px;line-height:30px;font-weight:700;font-style:normal;color:#00000c;text-decoration:none;letter-spacing:0px;">
                                                                                    <singleline>
                                                                                        <div mc:edit Simpli>
                                                                                            Electronic Surcharges:
                                                                                        </div>
                                                                                    </singleline>
                                                                                </td>
                                                                            </tr>
                                                                        ...
                                                                        <table border="0" align="left" cellpadding="0" cellspacing="0" role="presentation" width="70" style="width:70px;max-width:70px;">
                                                                            <tr>
                                                                                <td Simpli align="left" style="font-family:'Catamaran',Arial,Helvetica,sans-serif;font-size:20px;line-height:30px;font-weight:400;font-style:normal;color:#00000c;text-decoration:none;letter-spacing:0px;">
                                                                                    <singleline>
                                                                                        <div mc:edit Simpli>
                                                                                            $ {{$invoice->items->sum('fixed_price')}}
                                                                                        </div>
                                                                                    </singleline>
                                                                                </td>
                                                                            </tr>
                            ...
                            <tr>
                                <td align="center">
                                    ...
                                    <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="520" style="width:520px;max-width:520px;">
                                        <tr>
                                            <td align="center" height="80" Simpli style="font-family:'Catamaran',Arial,Helvetica,sans-serif;font-size:24px;line-height:32px;font-weight:700;font-style:normal;color:#FFFFFF;text-decoration:none;letter-spacing:0px;height:80px;border-radius: 80px;" bgcolor="#1898c2">
                                                <singleline>
                                                    <div mc:edit Simpli>
                                                        TOTAL: $ {{$invoice->items->sum('fixed_price') + $invoice->surchages}}
                                                    </div>
                                                </singleline>
                                            </td>
                                        </tr>
                            ...
                            <tr>
                                <td align="center">
                                    ...
                                    <table border="0" cellspacing="0" cellpadding="0" role="presentation" align="center" class="row" width="480" style="width:480px;max-width:480px;">
                                        <tr>
                                            <td class="center-text" Simpli align="center" style="font-family:'Catamaran',Arial,Helvetica,sans-serif;font-size:14px;line-height:26px;font-weight:400;font-style:italic;color:#333333;text-decoration:none;letter-spacing:0px;">
                                                <singleline>
                                                    <div mc:edit Simpli>
                                                        If you have any Questions about this invoice, please contact us at 917-877-0105 or sales@stueysgreenautoclean.com<br>Thank you very much for doing business with us.
                                                    </div>
                                                </singleline>
                                            </td>
                                        </tr>
