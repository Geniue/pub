                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="upload-btn-img">
                                    <?php if($post->image){ ?>
                                    <img src="{{env('BASE_URL').$post->image}}"
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-12">
                                ...
                                <ul class="pl-2 appendCondition">
                                    <li class="d-flex"><textarea name="content" class="form-control summernote" rows="5" cols="100" placeholder="content" required>{{$post->content}}</textarea></li>
                                </ul>
                            </div>
                        </div>
                        <div class="row justify-content-center">
