...
$site_title = "Upholstery and Carpet Cleaning in Union Square, NYC";
$site_description = "We serve Union Square, NYC with a variety of carpet cleaning and upholstery cleaning services. These include couch cleaning, area rug cleaning, sofa cleaning, mattress cleaning, carpet cleaning services, and more!";
$site_keywords = "";
$canonical = "";
$og_site_title = "";
$og_description = "";
...
<section id="top-banner" class="position-relative" style="min-height: 585px;">
  <img class="img lazy" data-src="/assets/images/service/10010-PristineGreen-Upholstery-and-Carpet-Cleaning-New-York-NY-Union-Square-Carpet-Cleaning.jpg" width="1920" height="590">
      ...
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="heading-text services-heading">
            <h1>Union Square, NYC<span class="blue"> <br/>Carpet Cleaning</span></h1>
      ...
      <div class="col-md-12">
        <div class="section-header text-center pb-4">
          <h2 class="lh-1-3 lh-md-auto fs-1 fs-md-3 mb-3 text-green text-uppercase">
            We Provide Carpet Cleaning Services in Union Square, NYC
          </h2>
        </div>
      </div>
      <div class="col-md-12">
        <p>
         PristineGreen Upholstery and Carpet Cleaning is a company that specializes in carpet, couch, and upholstery cleaning. We take pride in cleaning carpets and rugs without causing damage to the environment. We use five proprietary steps for the best results, removing dirt, stains, and allergens from a variety of materials. PristinGreen Cleaning is proud to offer green solutions for all of your cleaning needs, and they also provide other specialty services such as grout sealing and natural stone polishing.

        </p>
        <p>
         Our company is licensed to operate in Union Square. If you are considering hiring a carpet cleaner, contact PristineGreen Cleaning today. We offer same-day and emergency service! If you're in need of carpet cleaning in NYC, contact PristineGreen Cleaning.
        </p>
        <p>
         If you're looking for professional carpet cleaners in Union Square, give us a call and we'll give you a free instant quote on your furnishings. We are an honest company and the price we offer you is the price you pay (unless the items stated were smaller or larger than in reality). Speak with one of our representatives today to book an appointment so you too can enjoy the PristineGreen experience!
        </p> 
        <br/>
...
$pg_images = array(
  ...
  array(
    'url' => '10010%20New%20York%20%20NY%20PristineGreen%20Upholstery%20and%20Carpet%20Cleaning%20rug%20shampoo%20steam%20cleaner%20near%20me.jpg',
