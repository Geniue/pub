...
$site_title = "Upholstery and Carpet Cleaning in Alphabet City, NYC";
$site_description = "We serve Alphabet City, NYC with a variety of carpet cleaning and upholstery cleaning services. These include couch cleaning, area rug cleaning, sofa cleaning, mattress cleaning, carpet cleaning services, and more!";
$site_keywords = "";
$canonical = "";
$og_site_title = "";
$og_description = "";
...
<section id="top-banner" class="position-relative" style="min-height: 585px;">
  <img class="img lazy" data-src="/assets/images/service/alphabet-city-carpet-cleaning.jpg" width="1920" height="590">
      ...
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="heading-text services-heading">
            <h1>Alphabet City, NYC<span class="blue"> <br/>Carpet Cleaning</span></h1>
      ...
      <div class="col-md-12">
        <div class="section-header text-center pb-4">
          <h2 class="lh-1-3 lh-md-auto fs-1 fs-md-3 mb-3 text-green text-uppercase">
            We Provide Carpet Cleaning Services in Alphabet City, NYC
          </h2>
        </div>
      </div>
      <div class="col-md-12">
        <p>
          Hiring a Carpet Cleaning Service in Alphabet City is a great investment in your home. Not only do they make your carpets look good, but they can help you stay healthy as well. Over time, your carpet will collect dirt, bacteria, dust mites, allergens, and other contaminants that can pollute the air around your home. Even if your carpet looks clean on the outside, it might actually be dirty. You may not realize it, but it could be hiding dangerous allergens and bacteria deep down.
        </p>
        <p>
          The best carpet cleaning service in Alphabet City will be able to get rid of odors and other unpleasant stains. They will use natural products that are gentle on your carpets and won't harm your family's health. The cleaning agents that they use are non-toxic and safe for children and pets. Moreover, they will ensure that your carpets will look brand new again. This way, you can rest assured that your home is safe for your kids and pets.
        </p>
        <p>
         It is also important to choose a Carpet Cleaning Service that uses eco-friendly products. Some of the carpet cleaning services will use environmentally friendly products and solutions to clean your carpets. These companies are insured and bonded to protect their customers' belongings and reputations. A fully insured and bonded service will be happy to clean your carpets, regardless of where they're located. This is important because the cleaning company will need to be able to guarantee the quality of their work.
        </p>
        <p>
         If you're looking for professional carpet cleaners in Alphabet City, give us a call and we'll give you a free instant quote on your furnishings. We are an honest company and the price we offer you is the price you pay (unless the items stated were smaller or larger than in reality). Speak with one of our representatives today to book an appointment so you too can enjoy the PristineGreen experience!
        </p>
        <br/>
...
$pg_images = array(
  array(
    'url' => '11105%20carpet%20cleaner%20nyc%20NY%20PristineGreen%20Upholstery%20and%20Carpet%20Cleaning%20Queens%20rug%20cleaner%20nyc.jpg',
    'alt' => 'Alphabet City Rug Shampoo, Carpet cleaning service, carpet shampoo',
    'title' => 'Alphabet City Carpet Cleaner',
    'w' => 395,
    'h' => 527,
  ),
  array(
    ...
    'alt' => 'Alphabet City Area Rug Cleaning',
    'title' => 'Alphabet City Area Rug Cleaning',
    'w' => 395,
    'h' => 527,
  ),
  array(
