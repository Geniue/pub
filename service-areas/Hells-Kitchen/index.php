...
$site_title = "Upholstery and Carpet Cleaning in Hell's Kitchen, NYC";
$site_description = "We serve Hell's Kitchen, NYC with a variety of carpet cleaning and upholstery cleaning services. These include couch cleaning, area rug cleaning, sofa cleaning, mattress cleaning, carpet cleaning services, and more!";
$site_keywords = "";
$canonical = "";
$og_site_title = "";
$og_description = "";
...
<section id="top-banner" class="position-relative" style="min-height: 585px;">
  <img class="img lazy" data-src="/assets/images/service/Hells-Kitchen-Carpet-Cleaning-Service1.jpg" width="1920" height="590">
      ...
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="heading-text services-heading">
            <h1>Hell's Kitchen, NYC<span class="blue"> <br/>Carpet Cleaning</span></h1>
      ...
      <div class="col-md-12">
        <div class="section-header text-center pb-4">
          <h2 class="lh-1-3 lh-md-auto fs-1 fs-md-3 mb-3 text-green text-uppercase">
            We Provide Carpet Cleaning Services in Hell's Kitchen, NYC
          </h2>
        </div>
      </div>
      <div class="col-md-12">
        <p>
         The PristineGreen Upholstery and Carpet Cleaning company has been in business for over a few years. The company offers a wide range of services, from cleaning your couch and carpet to stain and odor removal and deodorizing. We also have a unique green stain formula to effectively remove tough stains. Whether your upholstery is made of silk or a Persian rug, PristineGreen can handle the job. Whether you have a commercial vehicle or a luxury home, PristineGreen can handle it all.

        </p>
        <p>
         The PristineGreen Upholstery and Carpet Cleaning team uses green cleaning products and innovative techniques to clean your carpet and upholstery. We also use non-toxic and safe cleaning agents and state-of-the-art equipment to ensure that no residues are left behind. You can rest assured that your carpet and upholstery will be clean, and we will use environmentally-friendly methods whenever possible. With our green cleaning products and advanced technology, the team at PrIstineGreen is the best choice for your carpet and upholstery needs.
        </p>
        <p>
         If you're looking for professional carpet cleaners in Hell's Kitchen, give us a call and we'll give you a free instant quote on your furnishings. We are an honest company and the price we offer you is the price you pay (unless the items stated were smaller or larger than in reality). Speak with one of our representatives today to book an appointment so you too can enjoy the PristineGreen experience
...
$pg_images = array(
  array(
    ...
    'alt' => ' Hells Kitchen rug shampoo, the best carpet cleaning, furniture steam cleaning, carpet shampoo',
    'title' => 'Hells Kitchen, carpet cleaner, furniture cleaning, furniture steam cleaning, mattress cleaner',
    'w' => 395,
    'h' => 527,
  ),
  array(
    ...
    'alt' => 'Hells Kitchen best carpet steam cleaner, upholstery cleaning, carpet cleaning solution',
    'title' => 'Hells Kitchen cleaner shampoo, steam clean a rug, best carpet steam cleaner',
    'w' => 395,
    'h' => 527,
  ),
  array(
