...
$site_title = "Upholstery and Carpet Cleaning in Nolita, NYC";
$site_description = "We serve Nolita, NYC with a variety of carpet cleaning and upholstery cleaning services. These include couch cleaning, area rug cleaning, sofa cleaning, mattress cleaning, carpet cleaning services, and more!";
$site_keywords = "";
$canonical = "";
$og_site_title = "";
$og_description = "";
...
<section id="top-banner" class="position-relative" style="min-height: 585px;">
  <img class="img lazy" data-src="/assets/images/service/Nolita-Carpet-Cleaning-Service.jpg" width="1920" height="590">
      ...
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="heading-text services-heading">
            <h1>Nolita, NYC<span class="blue"> <br/>Carpet Cleaning</span></h1>
...
<section id="main-content-cleaning" class="py-7 main-content-cleaning-service">
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-12">
        <p>
         The green cleaning methods used by PristineGreen Upholstery and Carpet Cleaning are not just for the environment. They're safe for you and your family, as well. Our company's services include carpet cleaning, upholstery cleaning, and even couch cleaning. We use eco-friendly products, so you can rest easy knowing that the cleaning process won't harm your home. These eco-friendly techniques are also safe for children, so you won't need to worry about exposing your kids to chemicals or harsh cleaners.

        </p>
        <p>
         PristineGreen Upholstery and Carpet Cleaning is a local carpet cleaning service in NYC. We use a five-step, proprietary cleaning process to remove dirt, allergens, and stains from your carpets and upholstery. Their eco-friendly approach to cleaning makes them the preferred choice of many New Yorkers. Our company is a 5-star rated company on Google+. which means that their customers are satisfied with our work.
        </p>
        <p>
         If you're looking for professional carpet cleaners in Nolita, give us a call and we'll give you a free instant quote on your furnishings. We are an honest company and the price we offer you is the price you pay (unless the items stated were smaller or larger than in reality). Speak with one of our representatives today to book an appointment so you too can enjoy the PristineGreen experience!
...
$pg_images = array(
  array(
    ...
    'alt' => ' Nolita rug shampoo, the best carpet cleaning, furniture steam cleaning, carpet shampoo',
    'title' => 'Nolita, carpet cleaner, furniture cleaning, furniture steam cleaning, mattress cleaner',
    'w' => 395,
    'h' => 527,
  ),
  array(
    ...
    'alt' => 'Nolita best carpet steam cleaner, upholstery cleaning, carpet cleaning solution',
    'title' => 'NOtila cleaner shampoo, steam clean a rug, best carpet steam cleaner',
    'w' => 395,
    'h' => 527,
  ),
  array(
