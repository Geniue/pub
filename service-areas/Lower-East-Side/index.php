...
$site_title = "Upholstery and Carpet Cleaning in Lower East Side, NYC";
$site_description = "We serve Lower East Side, NYC with a variety of carpet cleaning and upholstery cleaning services. These include couch cleaning, area rug cleaning, sofa cleaning, mattress cleaning, carpet cleaning services, and more!";
$site_keywords = "";
$canonical = "";
$og_site_title = "";
$og_description = "";
...
<section id="top-banner" class="position-relative" style="min-height: 585px;">
  <img class="img lazy" data-src="/assets/images/service/Lower-East-Side-Carpet-Cleaning.jpg" width="1920" height="590">
      ...
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="heading-text services-heading">
            <h1>Lower East Side, NYC<span class="blue"> <br/>Carpet Cleaning</span></h1>
      ...
      <div class="col-md-12">
        <div class="section-header text-center pb-4">
          <h2 class="lh-1-3 lh-md-auto fs-1 fs-md-3 mb-3 text-green text-uppercase">
            We Provide Carpet Cleaning Services in Lower East Side, NYC
          </h2>
        </div>
      </div>
      <div class="col-md-12">
        <p>
         PristineGreen Upholstery and Carpet Cleaning offer a wide range of services to fit any budget. Services include upholstering, carpet cleaning, stain removal, pet odor removal, industrial cleaning, and more. If you have a business, residential or commercial, we can help you get the job done right and keep your clients coming back! It's important to keep carpets clean and sanitize the fibers to prevent sickness and diseases later down the road. We use eco-friendly products that eliminate harsh chemicals and fibers that may irritate allergies, irritate the eyes, cause headaches, and more.

        </p>
        <p>
         Our company is run by technicians who strive to provide you with the best customer service possible. They are committed to providing quality service and products so that you will not only come back but recommend them to others. They have a strong commitment to offering the best green carpet clean as well as regular cleaning services to ensure the health and cleanliness of the carpets they clean. We always use a step-by-step cleaning process that takes into consideration the fabric of the item. We assess stains and choose the appropriate chemical and method to use to get them out. Our stain removers are non-toxic and safe to use on a wide range of stains, from pet stains, odor removal, food stains, and wine spills.
        </p>
        <p>
         If you're looking for professional carpet cleaners in Lower East Side, give us a call and we'll give you a free instant quote on your furnishings. We are an honest company and the price we offer you is the price you pay (unless the items stated were smaller or larger than in reality). Speak with one of our representatives today to book an appointment so you too can enjoy the PristineGreen experience
...
$pg_images = array(
  array(
    ...
    'alt' => ' Lower East Side carpet cleaner, couch steam cleaning, furniture steam cleaning,rug shampoo near me',
    'title' => 'Lower East Side, carpet cleaner, furniture cleaning, furniture steam cleaning, mattress cleaner',
    'w' => 395,
    'h' => 527,
  ),
  array(
    'url' => 	'11385%20couch%20cleaner%20Queens%20upholstery%20cleaning%20brooklyn%20NY%20PristineGreen%20Upholstery%20and%20Carpet%20Cleaning.jpg',
    'alt' => 'Lower East Side best carpet steam cleaner, upholstery cleaning, carpet cleaning solution',
    'title' => 'Lower East Side cleaner shampoo, steam clean a rug, best carpet steam cleaner',
    'w' => 395,
    'h' => 527,
  ),
  array(
