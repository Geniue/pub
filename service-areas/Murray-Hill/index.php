...
$site_title = "Upholstery and Carpet Cleaning in Murray Hill, NYC";
$site_description = "We serve Murray Hill, NYC with a variety of carpet cleaning and upholstery cleaning services. These include couch cleaning, area rug cleaning, sofa cleaning, mattress cleaning, carpet cleaning services, and more!";
$site_keywords = "";
$canonical = "";
$og_site_title = "";
$og_description = "";
...
<section id="top-banner" class="position-relative" style="min-height: 585px;">
  <img class="img lazy" data-src="/assets/images/service/10010-Murray-Hills-Carpet-Cleaning-NY-New-York -PristineGreen-Upholstery-and-Carpet-Cleaning.jpg" width="1920" height="590">
      ...
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="heading-text services-heading">
            <h1>Murray Hill, NYC<span class="blue"> <br/>Carpet Cleaning</span></h1>
      ...
      <div class="col-md-12">
        <div class="section-header text-center pb-4">
          <h2 class="lh-1-3 lh-md-auto fs-1 fs-md-3 mb-3 text-green text-uppercase">
            We Provide Carpet Cleaning Services in Murray Hill, NYC
          </h2>
        </div>
      </div>
      <div class="col-md-12">
        <p>
         PristineGreen Upholstery and Carpet Cleaning offer a variety of cleaning services that can help you keep your home looking as good as new. Our carpet cleaning services are a great choice for people in Murray Hill NY. PristineGreen cleaning offers a variety of other environmentally-friendly services, including pet stain removal and odor removal. We offer a variety of services, including carpet, couch, and upholstery cleaning. We are a five-star top carpet and upholstery cleaning company with locations in New York.
        </p>
        <p>
         If you're looking for professional carpet cleaners in Murray Hill, give us a call and we'll give you a free instant quote on your furnishings. We are an honest company and the price we offer you is the price you pay (unless the items stated were smaller or larger than in reality). Speak with one of our representatives today to book an appointment so you too can enjoy the PristineGreen experience!
        </p>
        <br/>
...
$pg_images = array(
  array(
    ...
    'alt' => 'Murray Hill Rug Shampoo, Carpet cleaning service, carpet shampoo',
    'title' => 'Murray Hill Carpet Cleaner,carpet cleaning solution, steam clean a rug',
    'w' => 345,
    'h' => 259,
  ),
  array(
    ...
    'alt' => 'Murray Hill Area Rug Cleaning, mattress cleaner, furniture cleaning',
    'title' => 'Murray Hill Area Rug Cleaning, sofa cleaning, steam clean a rug',
    'w' => 395,
    'h' => 527,
  ),
  array(
