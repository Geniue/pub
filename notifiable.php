...
try {
	...
	$id = $_GET["id"];
	$result = $connection->query("SELECT * FROM emails WHERE enc='${id}'");
	...
	$mail->Body    = "Call Back Request - pristinegreencleaning - please follow this link -> https://pristinegreencleaning.com/dashboard/request/temp/".$id."<br><br>".$main["email"];
